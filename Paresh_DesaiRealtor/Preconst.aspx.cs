...
namespace Property
{
    public partial class Preconst : System.Web.UI.Page
    {
        #region Page Load
         ...
         public void SendMailToAdmin(string UserEmailId)
        {
            ...
            body = body + "<p>Minimum Price : " + ddlCondoMinPrice.SelectedValue + "</p>";
            body = body + "<p>Maximum Price : " + ddlCondoMaxPrice.SelectedValue + "</p>";

            body = body + "<p>Property Type: " + prop + "</p>";
            body = body + "<p>Beds: " + ddlCondoBeds.SelectedValue + "</p>";
            body = body + "<p>Baths : " + ddlCondoBaths.SelectedValue + "</p>";
        ...
        public void SendMailToUser(string UserEmailId)
        {
            ...
            //Add Image
            LinkedResource theEmailImage = new LinkedResource("C:\\sites\\Sheikh Kashif_New\\Paresh_DesaiRealtor\\images\\thanks.png");
