    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content new_pop">
        ...
        <div class="modal-body modl_bg" >
            <div class="modl_sct">
            <%--<label>Name</label>--%>
            <input type="text" id="txtName" pattern="[a-zA-Z\s]+" title="Enter your name" Placeholder="Name"  value="" runat="server" />
         ...
         <div class="modl_sct">
            <%-- <label>Email</label>--%>
            <input type="text" name="email" Placeholder="E-Mail" id="txtEmailID" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Enter your emailID" runat="server" value="" />
        ...
        <asp:RegularExpressionValidator ID="rgeEmail" runat="server" ValidationGroup="FreeHome" Display="Dynamic" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
            ...
            <div class="modl_sct">
            <%-- <label>Phone</label>--%>
            <input type="text"  id="txtPhone"  Placeholder="Phone" pattern="[0-9]{10}" title="Enter your mobile number" value="" runat="server"/>
        ...
        <div class="modal-footer">
           <button id="btnSubmit" onserverclick="btnSaveUserInfo_Clicked" ValidationGroup="UserInfo" runat="server" class="btn btn-default mdl_sbmt_btn">Submit</button>
            <button type="button" id="btnClose" class="btn btn-default mdl_cls_btn">Close</button>
        </div>
      </div>
